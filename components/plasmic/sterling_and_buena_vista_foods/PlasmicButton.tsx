...
import sty from "./PlasmicButton.module.css"; // plasmic-import: IWAsz3YfYlWO/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__awbTa, {
          [sty.freeBoxcolor_neutral__awbTa2PuEu]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__awbTaki7ZOgxnz]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__awbTaTLqB]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__awbTan6Rdo]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__awbTaeEtzc]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__awbTaYq1Ly]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__awbTa6GNap]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__awbTaogxnz]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_soft__awbTawRAqG]: hasVariant($state, "type", "soft")
        })}
      >
        <div
          className={classNames("all", sty.freeBox___2KcTr, {
            [sty.freeBoxcolor_neutral___2KcTr2PuEu]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft___2KcTr2PuEuWRAqG]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart___2KcTrOj2Pj]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___2KcTrn6Rdo]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___2KcTrYq1Ly]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___2KcTr6GNap]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___2KcTrogxnz]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__gxqr1)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__vkQzf)}>
              {"Text"}
            </div>
          ),
          value: args.label,
        ...
        <div
          className={classNames("all", sty.freeBox__ov2Co, {
            [sty.freeBoxiconEnd__ov2CoIKkYl]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__ov2Con6Rdo]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__ov2CoYq1Ly]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__ov2Co6GNap]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames("all", sty.svg___2LBCn)}
                role={"img"}
              />
            ),
