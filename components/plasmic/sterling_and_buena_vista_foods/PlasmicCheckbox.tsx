...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: eKbEydnkpeX5/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: ZbuTLxCMnkFQ/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: VzMM6S4vzw7t/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames("all", sty.svg___2Trnv)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames("all", sty.svg__cgWcQ)}
            role={"img"}
          />
        ) : null}
      </div>
