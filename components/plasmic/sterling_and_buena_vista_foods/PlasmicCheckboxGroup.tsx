...
import Checkbox from "../../Checkbox"; // plasmic-import: eKbEydnkpeX5/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: Pjop31tIveHp/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", sty.freeBox__vQnH0)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ky95)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___4Yavu)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__cXGor)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
