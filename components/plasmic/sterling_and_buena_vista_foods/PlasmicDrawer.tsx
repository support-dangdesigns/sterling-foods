...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: GPCZvUkVUPAV/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_kwQh8QguXUwX"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames("all", sty.freeBox__vAFw)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox__kGv7Z)}>
                      <div
                        className={classNames(
                          "all",
                          "__wab_text",
              ...
              <div className={classNames("all", sty.freeBox__tPct)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div className={classNames("all", sty.freeBox__qthd4)}>
                      <Button
                        color={"muted"}
                        label={"Close"}
                        onClick={async event => {
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__b88Mv)}
                  color={"muted"}
                  label={
                    <div
                      className={classNames(
