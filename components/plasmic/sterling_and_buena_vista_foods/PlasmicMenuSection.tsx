...
import sty from "./PlasmicMenuSection.module.css"; // plasmic-import: s9IKYVB_wK3i/css
  ...
  return (
    <BaseSection
      ...
      items={renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <MenuItem clientLogin={"Section Item 1"} value={"section-item-1"} />

            <MenuItem clientLogin={"Section Item 2"} value={"section-item-2"} />

            <MenuItem clientLogin={"Section Item 3"} value={"section-item-3"} />
          </React.Fragment>
        ),
        value: args.items
      })}
