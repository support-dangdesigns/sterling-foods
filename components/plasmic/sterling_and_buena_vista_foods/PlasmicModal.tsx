...
import sty from "./PlasmicModal.module.css"; // plasmic-import: 2vyN6L2cHBHc/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_6Dj15CObTujL"]]: true })}
        ...
        >
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div className={classNames("all", sty.freeBox__ootNh)}>
                    <div
                      className={classNames(
                        "all",
                        "__wab_text",
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", sty.freeBox__i9Mbb)}>
                  <Button
                    color={"muted"}
                    label={
                      <div
