...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: Zo510exY2QRB/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: AZiT1M8NcqMD/css
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", sty.freeBox__xCr)}>
                  <div
                    className={classNames("all", "__wab_text", sty.text__bdxJj)}
                  >
                    {"This is a Popover!"}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__rLi2V)}
                  >
                    {"You can put anything here!"}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__ls2Ch)}
                  >
                    {
