...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: lWqxY9CExRmz/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames("all", sty.freeBox__epa5F)}>
        <div className={classNames("all", sty.freeBox__sDeAd)} />
      </div>
      {renderPlasmicSlot({
