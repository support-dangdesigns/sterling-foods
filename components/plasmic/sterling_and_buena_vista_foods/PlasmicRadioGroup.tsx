...
import Radio from "../../Radio"; // plasmic-import: lWqxY9CExRmz/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 0px0QcZxKHK6/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", sty.freeBox__aIdNl)}>
            <Radio
              className={classNames("__wab_instance", sty.radio___0LL22)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__aQz3Q)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__nmZz)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
