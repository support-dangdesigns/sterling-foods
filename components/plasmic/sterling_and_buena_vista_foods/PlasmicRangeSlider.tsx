...
import SliderThumb from "../../SliderThumb"; // plasmic-import: KX7qTq9yCzsB/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: L1fxAImBWjlO/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__zSfz2)}>
        {$props.showLabel ? (
          <Label
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames("all", "__wab_text", sty.text__zsM)}>
                  {"Label"}
                </div>
              ),
              value: args.label
      ...
      <div className={classNames("all", sty.freeBox__rUGn3)}>
        <div
