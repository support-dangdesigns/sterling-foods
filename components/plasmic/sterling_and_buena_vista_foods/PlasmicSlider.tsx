...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: cXUCL5A9plxt/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames("all", sty.freeBox___0NbPu)}>
          {$props.showLabel ? (
            <Label
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <div
                    className={classNames("all", "__wab_text", sty.text__b2DFj)}
                  >
                    {"Label"}
                  </div>
                ),
      ...
      <div className={classNames("all", sty.freeBox__qkxp1)}>
        <div
