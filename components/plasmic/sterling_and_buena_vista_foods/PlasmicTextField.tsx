...
import Label from "../../Label"; // plasmic-import: As6ceGvQWVP0/component
import TextInput from "../../TextInput"; // plasmic-import: LCW8K3ji_J8O/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: IOIjBwvA7ubT/component
import Description from "../../Description"; // plasmic-import: tSvFlz0KNg4B/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: icGGBGzV9SPv/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox___5SLcT, {
          [sty.freeBoxiconEnd___5SLcT0T75P]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___5SLcTtV6T9]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___5SLcTmYgDq]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames("all", sty.freeBox__hzUpc, {
            [sty.freeBoxiconStart__hzUpctV6T9]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__hzUpcMYgDq]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__mYpCt)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox__d2DLe, {
            [sty.freeBoxiconEnd__d2DLe0T75P]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__d2DLetV6T9]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg___5VTK)}
                role={"img"}
              />
            ),
