...
import sty from "./PlasmicTooltip.module.css"; // plasmic-import: 7PmIp04WX00w/css
...
function PlasmicTooltip__RenderFunc(props: {
  ...
  return (
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  <div
                    className={classNames("all", "__wab_text", sty.text__bs1U)}
                  >
                    {"Hello from Tooltip! "}
                  </div>
                  <div
                    className={classNames("all", "__wab_text", sty.text__erFo0)}
                  >
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", "__wab_text", sty.text__dBqP0)}>
            {"Hover me!"}
          </div>
        ),
        value: args.trigger,
