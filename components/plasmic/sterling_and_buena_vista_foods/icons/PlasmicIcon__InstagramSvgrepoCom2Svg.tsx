...
export type InstagramSvgrepoCom2SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function InstagramSvgrepoCom2SvgIcon(
  props: InstagramSvgrepoCom2SvgIconProps
) {
