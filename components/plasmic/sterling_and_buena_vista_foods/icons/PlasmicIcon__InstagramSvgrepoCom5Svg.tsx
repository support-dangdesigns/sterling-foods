...
export type InstagramSvgrepoCom5SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function InstagramSvgrepoCom5SvgIcon(
  props: InstagramSvgrepoCom5SvgIconProps
) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M11.999 7.377a4.623 4.623 0 1 0 0 9.248 4.623 4.623 0 0 0 0-9.248m0 7.627a3.004 3.004 0 1 1 0-6.008 3.004 3.004 0 0 1 0 6.008"
        }
      ></path>
...
export default InstagramSvgrepoCom5SvgIcon;
/* prettier-ignore-end */
