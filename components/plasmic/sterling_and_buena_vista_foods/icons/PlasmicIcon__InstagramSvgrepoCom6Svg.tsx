...
export type InstagramSvgrepoCom6SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function InstagramSvgrepoCom6SvgIcon(
  props: InstagramSvgrepoCom6SvgIconProps
) {
...
export default InstagramSvgrepoCom6SvgIcon;
/* prettier-ignore-end */
