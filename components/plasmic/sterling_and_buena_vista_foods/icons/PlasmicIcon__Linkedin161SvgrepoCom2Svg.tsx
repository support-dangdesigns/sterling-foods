...
export type Linkedin161SvgrepoCom2SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Linkedin161SvgrepoCom2SvgIcon(
  props: Linkedin161SvgrepoCom2SvgIconProps
) {
...
export default Linkedin161SvgrepoCom2SvgIcon;
/* prettier-ignore-end */
