...
export type Linkedin161SvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function Linkedin161SvgrepoComSvgIcon(
  props: Linkedin161SvgrepoComSvgIconProps
) {
...
export default Linkedin161SvgrepoComSvgIcon;
/* prettier-ignore-end */
