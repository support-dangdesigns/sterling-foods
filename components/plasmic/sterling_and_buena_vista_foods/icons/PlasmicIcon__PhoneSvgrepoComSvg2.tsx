...
export type PhoneSvgrepoComSvg2IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function PhoneSvgrepoComSvg2Icon(props: PhoneSvgrepoComSvg2IconProps) {
...
export default PhoneSvgrepoComSvg2Icon;
/* prettier-ignore-end */
