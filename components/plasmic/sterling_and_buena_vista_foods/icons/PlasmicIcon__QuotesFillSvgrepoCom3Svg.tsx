...
export type QuotesFillSvgrepoCom3SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function QuotesFillSvgrepoCom3SvgIcon(
  props: QuotesFillSvgrepoCom3SvgIconProps
) {
...
export default QuotesFillSvgrepoCom3SvgIcon;
/* prettier-ignore-end */
